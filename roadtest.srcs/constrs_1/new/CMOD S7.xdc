...
set_property -dict { PACKAGE_PIN L12   IOSTANDARD LVCMOS33 } [get_ports  sTX_MCU ]; #IO_L6N_T0_D08_VREF_14 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports  sRX_MCU ]; #IO_L5N_T0_D07_14 Sch=uart_txd_in
...
#set_property -dict {PACKAGE_PIN L1 IOSTANDARD LVCMOS33} [get_ports cl]
#set_property -dict {PACKAGE_PIN M4 IOSTANDARD LVCMOS33} [get_ports sTX_IMU];
#set_property -dict {PACKAGE_PIN M3 IOSTANDARD LVCMOS33} [get_ports sDREA]
#set_property -dict {PACKAGE_PIN N2 IOSTANDARD LVCMOS33} [get_ports simr]
#set_property -dict {PACKAGE_PIN P3 IOSTANDARD LVCMOS33} [get_ports sTX_MCU]
#set_property -dict {PACKAGE_PIN N3 IOSTANDARD LVCMOS33} [get_ports sRX_IMU];
#set_property -dict {PACKAGE_PIN P1 IOSTANDARD LVCMOS33} [get_ports sflash1]
#set_property -dict {PACKAGE_PIN N1 IOSTANDARD LVCMOS33} [get_ports sflash2]
#set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports sflash3]
#set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports sflash4]
#set_property -dict {PACKAGE_PIN N13 IOSTANDARD LVCMOS33} [get_ports sINIT]
#set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports sTRIGG]
#set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports sNOGO]
#set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports sPPS]
...
#set_property SLEW FAST [get_ports sTX_MCU]
