...
ENTITY uart_MCU_6MHz IS
    GENERIC(
        clk_freq        :    INTEGER        := 360_000_000;    --frequency of system clock in Hertz
        baud_rate    :    INTEGER        := 6_000_000;        --data link baud rate in bits/second
        os_rate        :    INTEGER        := 20;            --oversampling rate to find center of receive bits (in samples per baud period)
...
ARCHITECTURE logic OF uart_MCU_6MHz IS
