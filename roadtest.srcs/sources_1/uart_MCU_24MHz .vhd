...
ENTITY uart_MCU_24MHz IS
    GENERIC(
        clk_freq        :    INTEGER        := 360_000_000;    --frequency of system clock in Hertz
        baud_rate    :    INTEGER        := 24_000_000;        --data link baud rate in bits/second
        os_rate        :    INTEGER        := 5;            --oversampling rate to find center of receive bits (in samples per baud period)
...
ARCHITECTURE logic OF uart_MCU_24MHz IS
