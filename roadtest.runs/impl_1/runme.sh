...
HD_PWD='C:/vivado_proyects/roadtest/roadtest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log C7mod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source C7mod.tcl -notrace
