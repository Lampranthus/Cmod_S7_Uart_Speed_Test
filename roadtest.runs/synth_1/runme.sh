...
HD_PWD='C:/vivado_proyects/roadtest/roadtest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log C7mod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source C7mod.tcl
